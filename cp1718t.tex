...
\\
\>[B]{}\Varid{recBlockchain}\;\Varid{f}\;(i_1\;\Varid{b1})\mathrel{=}i_1\;\Varid{b1}{}\<[E]%
\\
\>[B]{}\Varid{recBlockchain}\;\Varid{f}\;(i_2\;(\Varid{b2},\Varid{c}))\mathrel{=}i_2\;(\Varid{b2},\Varid{f}\;\Varid{c}){}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\;\Varid{bc}\mathrel{=}(\Varid{cataBlockchain}\;\Varid{g}\;\Varid{bc})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Transactions})\to \Conid{Transactions}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;\Varid{b})\mathrel{=}(\p2\comp \p2)\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;(\Varid{b},\Varid{t}))\mathrel{=}(\p2\comp \p2)\;\Varid{b}\plus \Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\;\Varid{bc}\mathrel{=}\Varid{cataList}\;\Varid{g3}\;(\Varid{sort}\;(\Varid{cataBlockchain}\;\Varid{g1}\;\Varid{bc}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_1\;\Varid{b})\mathrel{=}\Varid{cataList}\;\Varid{g2}\;((\p2\comp \p2)\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_2\;(\Varid{b},\Varid{t}))\mathrel{=}\Varid{cataList}\;\Varid{g2}\;((\p2\comp \p2)\;\Varid{b})\plus \Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathbin{::}()+(\Conid{Transaction},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(i_1\;\Varid{b})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(i_2\;(\Varid{b},\Varid{t}))\mathrel{=}(\p1\;\Varid{b},\mathbin{-}(\p1\;(\p2\;\Varid{b})))\mathbin{:}(\p2\;(\p2\;\Varid{b}),(\p1\;(\p2\;\Varid{b})))\mathbin{:}\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\mathbin{::}()+((\Conid{Entity},\Conid{Value}),\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(i_1\;\Varid{b})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(i_2\;((\Varid{e},\Varid{v}),\Varid{l}))\mid \Varid{l}\equiv [\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu (\Varid{e},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{21}{}\<[24]%
\>[24]{}\mid \Varid{otherwise}\mathrel{=}\mathbf{if}\;(\p1\;(\Varid{head}\;\Varid{l})\equiv \Varid{e})\;\mathbf{then}\;(\Varid{e},\p2\;(\Varid{head}\;\Varid{l})\mathbin{+}\Varid{v})\mathbin{:}(\Varid{tail}\;\Varid{l})\;\mathbf{else}\;(\Varid{e},\Varid{v})\mathbin{:}\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\;\Varid{bc}\mathrel{=}\length \;\Varid{listMagicNo}\leq \length \;(\Varid{cataList}\;\Varid{g2}\;\Varid{listMagicNo})\;{}\<[77]%
\>[77]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{listMagicNo}\mathrel{=}\Varid{cataBlockchain}\;\Varid{g1}\;\Varid{bc}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathbin{::}\Conid{Block}+(\Conid{Block},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_1\;\Varid{b})\mathrel{=}[\mskip1.5mu \p1\;\Varid{b}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_2\;(\Varid{b},\Varid{l}))\mathrel{=}(\p1\;\Varid{b})\mathbin{:}\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathbin{::}()+(\Conid{MagicNo},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(i_1\;\Varid{b})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(i_2\;(\Varid{n},\Varid{l}))\mathrel{=}\mathbf{if}\;\Varid{elem}\;\Varid{n}\;\Varid{l}\;\mathbf{then}\;\Varid{l}\;\mathbf{else}\;\Varid{n}\mathbin{:}\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{g}\;(i_1\;(\Varid{a},\Varid{b}))\mathrel{=}i_1\;(\Varid{f}\;\Varid{a},\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{g}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}i_2\;(\Varid{g}\;\Varid{a},(\Varid{g}\;\Varid{b},(\Varid{g}\;\Varid{c},\Varid{g}\;\Varid{d}))){}\<[E]%
\\
\>[B]{}\Varid{recQTree}\;\Varid{f}\;(i_1\;(\Varid{a},\Varid{b}))\mathrel{=}i_1\;(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{recQTree}\;\Varid{f}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}i_2\;(\Varid{f}\;\Varid{a},(\Varid{f}\;\Varid{b},(\Varid{f}\;\Varid{c},\Varid{f}\;\Varid{d}))){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathsf{fmap}\;\Varid{f}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}\Conid{Cell}\;(\Varid{f}\;\Varid{a})\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathsf{fmap}\;\Varid{f}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Conid{Block}\;(\mathsf{fmap}\;\Varid{f}\;\Varid{a})\;(\mathsf{fmap}\;\Varid{f}\;\Varid{b})\;(\mathsf{fmap}\;\Varid{f}\;\Varid{c})\;(\mathsf{fmap}\;\Varid{f}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\;\Varid{t}\mathrel{=}\Varid{cataQTree}\;\Varid{g}\;\Varid{t}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Varid{b},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{b},(\Conid{QTree}\;\Varid{b},(\Conid{QTree}\;\Varid{b},\Conid{QTree}\;\Varid{b})))\to \Conid{QTree}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;(\Varid{a},\Varid{p}))\mathrel{=}\Varid{inQTree}\;(i_1\;(\Varid{a},\Varid{swap}\;\Varid{p})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{scaleQTree}\;\Varid{s}\;\Varid{t}\mathrel{=}\Varid{cataQTree}\;\Varid{g}\;\Varid{t}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Varid{b},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{b},(\Conid{QTree}\;\Varid{b},(\Conid{QTree}\;\Varid{b},\Conid{QTree}\;\Varid{b})))\to \Conid{QTree}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;(\Varid{a},(\Varid{x},\Varid{y})))\mathrel{=}\Conid{Cell}\;\Varid{a}\;(\Varid{x}\mathbin{*}\Varid{s})\;(\Varid{y}\mathbin{*}\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{invertQTree}\mathrel{=}\Varid{cataQTree}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Conid{PixelRGBA8},(\Conid{QTree}\;\Conid{PixelRGBA8},{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\Conid{QTree}\;\Conid{PixelRGBA8},\Conid{QTree}\;\Conid{PixelRGBA8})))\to \Conid{QTree}\;\Conid{PixelRGBA8}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a},(\Varid{x},\Varid{y})))\mathrel{=}\Conid{Cell}\;(\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a})\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{rate}\;\Varid{tree}\mathrel{=}\Varid{hyloQTree}\;\Varid{f}\;\Varid{g}\;(\Varid{tree},\Varid{depthQTree}\;\Varid{tree})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{QTree}\;\Varid{a},\Conid{Int})\to ((\Varid{a},\Conid{Int}),(\Conid{Int},\Conid{Int}))+((\Conid{QTree}\;\Varid{a},\Conid{Int}),((\Conid{QTree}\;\Varid{a},\Conid{Int}),{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}((\Conid{QTree}\;\Varid{a},\Conid{Int}),(\Conid{QTree}\;\Varid{a},\Conid{Int})))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;((\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}),\Varid{n})\mathrel{=}i_1\;((\Varid{a},\Varid{n}),(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;((\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}),\Varid{n})\mathrel{=}\mathbf{if}\;\Varid{n}\mathbin{>}\Varid{rate}\;\mathbf{then}\;i_2\;((\Varid{a},\Varid{n}\mathbin{-}\mathrm{1}),((\Varid{b},\Varid{n}\mathbin{-}\mathrm{1}),((\Varid{c},\Varid{n}\mathbin{-}\mathrm{1}),(\Varid{d},\Varid{n}\mathbin{-}\mathrm{1})))){}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\mathbf{else}\;i_1\;(\Varid{getElem}\;\Varid{a}\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{getElem}\;(\Conid{Cell}\;\Varid{a}\;\anonymous \;\anonymous )\;(\Varid{acX},\Varid{acY})\mathrel{=}((\Varid{a},\mathrm{0}),(\Varid{acX},\Varid{acY})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{getElem}\;(\Conid{Block}\;\Varid{a}\;\anonymous \;\anonymous \;\anonymous )\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{getElem}\;\Varid{a}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathbin{::}((\Varid{a},\Conid{Int}),(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(i_1\;((\Varid{a},\Varid{n}),(\Varid{x},\Varid{y})))\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(i_2\;\Varid{b})\mathrel{=}\Varid{inQTree}\;(i_2\;\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\;\Varid{tree}\mathrel{=}\Varid{qt2bm}\;(\Varid{cataQTree}\;\Varid{g1}\;(\mathsf{fmap}\;\Varid{f}\;\Varid{tree}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathbin{::}(\Conid{Bool},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Conid{Bool},(\Conid{QTree}\;\Conid{Bool},(\Conid{QTree}\;\Conid{Bool},\Conid{QTree}\;\Conid{Bool})))\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_1\;(\Varid{a},(\Varid{x},\Varid{y})))\mathrel{=}\mathbf{if}\;\Varid{a}\;\mathbf{then}\;\Varid{part}\;(\Varid{qt2bm}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}))\;\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{part}\mathbin{::}\Conid{Matrix}\;\Conid{Bool}\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{part}\;\Varid{m}\mathrel{=}\Varid{bm2qt}\mathbin{\$}\Varid{mapPos}\;(\lambda (\Varid{r},\Varid{c})\;\Varid{a}\to (\Varid{r}\equiv \mathrm{1}\mathrel{\vee}\Varid{r}\equiv \Varid{nrows}\;\Varid{m})\mathrel{\vee}(\Varid{c}\equiv \mathrm{1}\mathrel{\vee}\Varid{c}\equiv \Varid{ncols}\;\Varid{m}))\;\Varid{m}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
	\ensuremath{\conj{\cata{\alt{\conj{\mathrm{1}}{\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}{\cata{\alt{\conj{\mathrm{1}}{\Varid{k}\mathbin{+}\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}}
%
\just\equiv{ Banana split }
%
  \ensuremath{\cata{(\alt{\conj{\mathrm{1}}{\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\times\alt{\conj{\mathrm{1}}{\Varid{k}\mathbin{+}\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}})\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2}}}
%
\just\equiv{ Absorção X }
%
  \ensuremath{\cata{\conj{\alt{\conj{\mathrm{1}}{\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Conid{F}\;\p1)}{\alt{\conj{\mathrm{1}}{\Varid{k}\mathbin{+}\mathrm{1}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Conid{F}\;\p2)}}}
%
\just\equiv{ Def F p1, F p2; Absorção + }
%
  \ensuremath{\cata{\conj{\alt{\conj{\mathrm{1}}{\mathrm{1}}\comp \Varid{id}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p1}}{\alt{\conj{\mathrm{1}}{\Varid{k}\mathbin{+}\mathrm{1}}\comp \Varid{id}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p2}}}}
%
\just\equiv{ Lei da Troca; Def. X }
%
  \ensuremath{\cata{\alt{\conj{\conj{\mathrm{1}}{\Varid{k}\mathbin{+}\mathrm{1}}}{\conj{\mathrm{1}}{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2}}}}
...
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{pairConcat}\comp (\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2})\comp \Varid{pairDecat}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{pairConcat}\;((\Varid{x},\Varid{y}),(\Varid{w},\Varid{z}))\mathrel{=}(\Varid{x},\Varid{y},\Varid{w},\Varid{z}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{pairDecat}\;(\Varid{x},\Varid{y},\Varid{w},\Varid{z})\mathrel{=}((\Varid{x},\Varid{y}),(\Varid{w},\Varid{z})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{h}\;(i_1\;\Varid{b})\mathrel{=}i_1\;(\Varid{g}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{h}\;(i_2\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}i_2\;(\Varid{f}\;\Varid{a},(\Varid{h}\;\Varid{b},\Varid{h}\;\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{recFTree}\;\Varid{f}\;(i_1\;\Varid{b})\mathrel{=}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{recFTree}\;\Varid{f}\;(i_2\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}i_2\;(\Varid{a},(\Varid{f}\;\Varid{b},\Varid{f}\;\Varid{c})){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{bimap}\;\Varid{f}\;\Varid{g}\;(\Conid{Unit}\;\Varid{b})\mathrel{=}{}\<[27]%
\>[27]{}\Conid{Unit}\;(\Varid{g}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{bimap}\;\Varid{f}\;\Varid{g}\;(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}\Conid{Comp}\;(\Varid{f}\;\Varid{a})\;(\Varid{bimap}\;\Varid{f}\;\Varid{g}\;\Varid{b})\;(\Varid{bimap}\;\Varid{f}\;\Varid{g}\;\Varid{c}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\;\Varid{n}\mathrel{=}\Varid{anaFTree}\;\Varid{g}\;(\mathrm{50},\Varid{n})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{Float},\Conid{Int})\to \Conid{Square}+(\Conid{Square},((\Conid{Square},\Conid{Int}),(\Conid{Square},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Varid{size},\mathrm{0})\mathrel{=}i_1\;\Varid{size}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Varid{size},\Varid{l})\mathrel{=}i_2\;(\Varid{size},((\Varid{newsize},\Varid{l}\mathbin{-}\mathrm{1}),(\Varid{newsize},\Varid{l}\mathbin{-}\mathrm{1})))\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{newsize}\mathrel{=}((\Varid{sqrt}\;\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{*}\Varid{size}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\;\Varid{p}\mathrel{=}\Varid{hyloFTree}\;\Varid{f}\;\Varid{g}\;(\Varid{p},(\mathrm{0},\mathrm{0}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{PTree},(\Conid{Float},\Conid{Float}))\to (\Conid{Picture},(\Conid{Float},\Conid{Float}))+(\Conid{Picture},((\Conid{PTree},(\Conid{Float},\Conid{Float})),(\Conid{PTree},(\Conid{Float},\Conid{Float})))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Conid{Unit}\;\Varid{b},(\Varid{x},\Varid{y}))\mathrel{=}i_1\mathbin{\$}((\Conid{Translate}\;\Varid{x}\;\Varid{y}\mathbin{\$}\Varid{rectangleSolid}\;\Varid{b}\;\Varid{b}),(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c},(\Varid{x},\Varid{y}))\mathrel{=}i_2\mathbin{\$}(\Conid{Translate}\;\Varid{x}\;\Varid{y}\mathbin{\$}\Varid{rectangleSolid}\;\Varid{a}\;\Varid{a},((\Varid{b},(\mathbin{-}\Varid{a}\mathbin{/}\mathrm{2},\Varid{a})),(\Varid{c},(\Varid{a}\mathbin{/}\mathrm{2},\Varid{a}))))\;\mathbf{where}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathbin{::}(\Conid{Picture},(\Conid{Float},\Conid{Float}))+(\Conid{Picture},([\mskip1.5mu \Conid{Picture}\mskip1.5mu],[\mskip1.5mu \Conid{Picture}\mskip1.5mu]))\to [\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(i_1\;(\Varid{p},(\Varid{x},\Varid{y})))\mid \Varid{x}\mathbin{<}\mathrm{0}\mathrel{=}[\mskip1.5mu \Conid{Rotate}\;\mathrm{30}\;\Varid{p}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
\>[22]{}\mid \Varid{x}\mathbin{>}\mathrm{0}\mathrel{=}[\mskip1.5mu \Conid{Rotate}\;(\mathbin{-}\mathrm{30})\;\Varid{p}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
\>[22]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \Varid{p}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(i_2\;(\Varid{base},(\Varid{tl},\Varid{tr})))\mathrel{=}\Varid{base}\mathbin{:}\Varid{pl}\mathbin{:}[\mskip1.5mu \Varid{pr}\mskip1.5mu]\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{pl}\mathrel{=}\Conid{Rotate}\;\mathrm{30}\mathbin{\$}\Varid{pictures}\;\Varid{tl}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{pr}\mathrel{=}\Conid{Rotate}\;(\mathbin{-}\mathrm{30})\mathbin{\$}\Varid{pictures}\;\Varid{tr}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{singletonbag}\mathbin{::}\Varid{a}\to \Conid{Bag}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{singletonbag}\mathrel{=}\mathit B\comp \Varid{singl}\comp \Varid{swap}\comp (,)\;\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mu \;\Varid{b}\mathrel{=}\Varid{cataList}\;\Varid{g}\;(\Varid{unB}\;(\mathsf{fmap}\;\Varid{unB}\;\Varid{b}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}()+(([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int}),\Conid{Bag}\;\Varid{a})\to \Conid{Bag}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;\Varid{x})\mathrel{=}\mathit B\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;((\Varid{l},\Varid{n}),\Varid{n2}))\mathrel{=}\mathit B\mathbin{\$}(\Varid{anaList}\;\Varid{f}\;(\Varid{l},\Varid{n}))\plus (\Varid{unB}\;\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to ()+((\Varid{a},\Conid{Int}),([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;([\mskip1.5mu \mskip1.5mu],\anonymous )\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(((\Varid{a},\Varid{n})\mathbin{:}\Varid{t}),\Varid{n2})\mathrel{=}i_2\;((\Varid{a},\Varid{n}\mathbin{*}\Varid{n2}),(\Varid{t},\Varid{n2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\;\Varid{bag}\mathrel{=}\Conid{D}\mathbin{\$}\Varid{anaList}\;\Varid{f}\;(\Varid{unB}\;\Varid{bag},(\Varid{cataList}\;\Varid{g}\mathbin{\$}\Varid{unB}\;\Varid{bag}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(()+((\Varid{a},\Conid{Int}),\Conid{Int}))\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_1\;\anonymous )\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(i_2\;((\Varid{a},\Varid{n}),\Varid{tot}))\mathrel{=}\Varid{n}\mathbin{+}\Varid{tot}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to ()+((\Varid{a},\Conid{ProbRep}),([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;([\mskip1.5mu \mskip1.5mu],\anonymous )\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;(((\Varid{a},\Varid{local})\mathbin{:}\Varid{t}),\Varid{tot})\mathrel{=}i_2\;((\Varid{a},\Varid{prob}),(\Varid{t},\Varid{tot}))\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{prob}\mathrel{=}(\Varid{fromIntegral}\;\Varid{local})\mathbin{/}(\Varid{fromIntegral}\;\Varid{tot}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
