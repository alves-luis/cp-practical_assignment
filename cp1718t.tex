...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Conid{PixelRGBA8},(\Conid{QTree}\;\Conid{PixelRGBA8},(\Conid{QTree}\;\Conid{PixelRGBA8},\Conid{QTree}\;\Conid{PixelRGBA8})))\to \Conid{QTree}\;\Conid{PixelRGBA8}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{QTree}\;\Varid{a},\Conid{Int})\to ((\Varid{a},\Conid{Int}),(\Conid{Int},\Conid{Int}))+((\Conid{QTree}\;\Varid{a},\Conid{Int}),((\Conid{QTree}\;\Varid{a},\Conid{Int}),((\Conid{QTree}\;\Varid{a},\Conid{Int}),(\Conid{QTree}\;\Varid{a},\Conid{Int})))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;((\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}),\Varid{n})\mathrel{=}i_1\;((\Varid{a},\Varid{n}),(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;((\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}),\Varid{n})\mathrel{=}\mathbf{if}\;\Varid{n}\mathbin{>}\Varid{rate}\;\mathbf{then}\;i_2\;((\Varid{a},\Varid{n}\mathbin{-}\mathrm{1}),((\Varid{b},\Varid{n}\mathbin{-}\mathrm{1}),((\Varid{c},\Varid{n}\mathbin{-}\mathrm{1}),(\Varid{d},\Varid{n}\mathbin{-}\mathrm{1}))))\;\mathbf{else}\;i_1\;(\Varid{getElem}\;\Varid{a}\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
%
  \ensuremath{\cata{\conj{\alt{\conj{\mathrm{1}}{\mathrm{1}}\comp \Varid{id}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p1}}{\cdot }}}
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\;\Varid{n}\mathrel{=}\Varid{anaFTree}\;\Varid{g}\;\Varid{n}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}\Conid{Int}\to \Conid{Square}+(\Conid{Square},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;\mathrm{0}\mathrel{=}i_1\;\mathrm{5}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;\Varid{l}\mathrel{=}i_2\;((\Varid{sqrt}\;\mathrm{2})\mathbin{*}\alt{\Varid{id}}{\Varid{b}}\;(\Varid{g}\;(\Varid{l}\mathbin{-}\mathrm{1})),(\Varid{l}\mathbin{-}\mathrm{1},\Varid{l}\mathbin{-}\mathrm{1})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\mathbin{::}(\Conid{Square},(\Conid{Int},\Conid{Int}))\to \Conid{Square}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\;(\Varid{s},(\anonymous ,\anonymous ))\mathrel{=}\Varid{s}{}\<[E]%
\\
\>[B]{}\Varid{drawPTree}\;\Varid{p}\mathrel{=}\Varid{cataFTree}\;\Varid{g1}\;\Varid{p}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp \Varid{concat}\comp \map \;\Varid{pairToList}\comp \Varid{unB}\comp \mathsf{fmap}\;\Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{pairToList}\mathbin{::}(\Varid{a},\Conid{Int})\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{pairToList}\mathrel{=}\uncurry{\Varid{replicate}}\comp \Varid{swap}{}\<[E]%
\\[\blanklineskip]%
