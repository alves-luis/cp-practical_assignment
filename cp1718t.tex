...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\;\Varid{n}\mathrel{=}\Varid{anaFTree}\;\Varid{g}\;(\mathrm{100},\Varid{n})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}(\Conid{Float},\Conid{Int})\to \Conid{Square}+(\Conid{Square},((\Conid{Square},\Conid{Int}),(\Conid{Float},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\;\Varid{p}\mathrel{=}\Varid{hyloFTree}\;\Varid{f}\;\Varid{g}\;(\Varid{p},)\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathbin{::}\Conid{Square}+(\Conid{Square},([\mskip1.5mu \Conid{Picture}\mskip1.5mu],[\mskip1.5mu \Conid{Picture}\mskip1.5mu]))\to [\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_1\;\Varid{s})\mathrel{=}[\mskip1.5mu \Varid{rectangleSolid}\;\Varid{s}\;\Varid{s}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;(i_2\;(\Varid{s},(\Varid{l1},\Varid{l2})))\mathrel{=}(\Varid{rectangleSolid}\;\Varid{s}\;\Varid{s})\mathbin{:}\Varid{rotatePotate}\;\Varid{l1}\;\Varid{s}\mathbin{:}[\mskip1.5mu \Varid{rotatePotateTwo}\;\Varid{l2}\;\Varid{s}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{rotatePotate}\mathbin{::}[\mskip1.5mu \Conid{Picture}\mskip1.5mu]\to \Conid{Square}\to \Conid{Picture}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{rotatePotate}\;\Varid{l}\;\Varid{s}\mathrel{=}\Conid{Translate}\;\mathrm{0}\;\Varid{s}\mathbin{\$}\Conid{Rotate}\;(\mathbin{-}\mathrm{60})\mathbin{\$}\Varid{pictures}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{rotatePotateTwo}\;\Varid{l}\;\Varid{s}\mathrel{=}\Conid{Translate}\;\mathrm{0}\;\Varid{s}\mathbin{\$}\Conid{Rotate}\;\mathrm{60}\mathbin{\$}\Varid{pictures}\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\;(\mathit B\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}\Conid{D}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{dist}\;\Varid{bag}\mathrel{=}\Varid{mkD}\mathbin{\$}\map \;(\Varid{id}\times\Varid{getProb})\mathbin{\$}\Varid{unB}\;\Varid{bag}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{getProb}\mathbin{::}\Conid{Int}\to \Conid{ProbRep}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{getProb}\;\Varid{a}\mathrel{=}(\Varid{fromIntegral}\;\Varid{a})\mathbin{/}(\Varid{fromIntegral}\mathbin{\$}\Varid{countBag}\;\Varid{bag}){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{countBag}\mathbin{::}\Conid{Bag}\;\Varid{a}\to \Conid{Int}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{countBag}\mathrel{=}(\Varid{foldr}\;((\mathbin{+})\comp \p2)\;\mathrm{0})\comp \Varid{unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
