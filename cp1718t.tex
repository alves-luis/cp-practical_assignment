...
\>[3]{}\Varid{g}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{rate}\;\Varid{tree}\mathrel{=}\Varid{anaQTree}\;\Varid{g}\;\Varid{tree}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{maxSize}\mathrel{=}\Varid{depthQTree}\;\Varid{tree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{outQTree}\mathbin{\$}\Conid{Block}\;(\Varid{prop}\;\Varid{a})\;(\Varid{prop}\;\Varid{b})\;(\Varid{prop}\;\Varid{c})\;(\Varid{prop}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prop}\;\Varid{tree}\mathrel{=}\mathbf{if}\;(\Varid{depthQTree}\;\Varid{tree}\mathbin{+}\mathrm{1})\mathbin{>}\Varid{maxSize}\mathbin{-}\Varid{rate}\;\mathbf{then}\;\Varid{compressQTree}\;(\Varid{rate}\mathbin{+}\mathrm{1})\;\Varid{tree}\;\mathbf{else}\;\Varid{tree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prune}\mathbin{::}\Conid{QTree}\;\Varid{a}\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prune}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prune}\;(\Conid{Block}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\;(\Conid{Cell}\;\anonymous \;\anonymous \;\anonymous )\;(\Conid{Cell}\;\anonymous \;\anonymous \;\anonymous )\;(\Conid{Cell}\;\anonymous \;\anonymous \;\anonymous ))\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prune}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Conid{Block}\;(\Varid{prune}\;\Varid{a})\;(\Varid{prune}\;\Varid{b})\;(\Varid{prune}\;\Varid{c})\;(\Varid{prune}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
